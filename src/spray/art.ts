 ...
 * `mono` keeps the original magenta piece; the others each carry their own,
 * with mist and drip colours tuned to match.
 */
export const ART: Record<CanVariant, Art> = {
  mono: { src: 'assets/mural.png', hues: ['255,72,214', '176,86,255'], splat: '255,80,215' },
